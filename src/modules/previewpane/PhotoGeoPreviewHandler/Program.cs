...
// Temporarily commented out for development - uncomment before PR
...
namespace Microsoft.PowerToys.PreviewHandler.PhotoGeo
{
    internal static class Program
    {
        ...
        private static PhotoGeoPreviewHandlerControl _previewHandlerControl;
        ...
        public static void Main(string[] args)
        {
            ...
            if (args != null)
            {
                if (args.Length == 6)
                {
                    ...
                    _previewHandlerControl = new PhotoGeoPreviewHandlerControl();
                    ...
                    // Temporarily simplified for development - restore NativeEventWaiter before PR
                    // NativeEventWaiter.WaitForEventLoop(
                    //     Constants.PhotoGeoPreviewResizeEvent(),
                    //     () =>
                    //     {
                    //         Rectangle s = default;
