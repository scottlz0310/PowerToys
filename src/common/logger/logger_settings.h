...
struct LogSettings
{
    ...
    inline const static std::string photoGeoPrevLoggerName = "PhotoGeoPrevHandler";
    inline const static std::wstring photoGeoPrevLogPath = L"logs\\FileExplorer_localLow\\PhotoGeoPrevHandler\\photogeo-prev-handler-log.log";
